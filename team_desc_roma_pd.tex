...
\author{Marco Imperoli \and Daniele Evangelista \and Valerio Sanelli \and Matteo Russo\and\\ Alberto Pretto \and Daniele Nardi}
...
\email{valerio.sanelli@gmail.com}
\email{matteo.russo@unicas.it}\\
...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=0.6\linewidth]{images/kuka.JPG}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[angle=0,width=0.5\linewidth]{images/d2co_00.png}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[angle=0,width=0.7\linewidth]{images/dcd_building.pdf}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[angle=0,width=0.8\linewidth]{images/d2co_02.png}
\end{center}
